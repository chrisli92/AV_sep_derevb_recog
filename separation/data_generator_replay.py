...
class CHDataset(object):
    def __init__(self, stage):
        ...
        self.max_nspk = 3
        if self.stage == 'tr':
            self.info = pickle.load(open(os.path.join(data_dir, "train_pretrain_rev1.pkl"), 'rb'), encoding='utf-8')
        elif self.stage == 'cv':
            ...
            self.info = pickle.load(open(os.path.join(data_dir, "test_replay.pkl"), 'rb'), encoding='utf-8')
            self.info_ref = pickle.load(open(os.path.join(data_dir, "test_rev4.pkl"), 'rb'), encoding='utf-8')
