...
if not AF_premasking:
    if resume:
        ...
        training_model_subpath="model_tfmasking-AF_premasking=False-Batch_Size=64=Add_Visual=True/uTGT-LPS_IPD_AF-b64-BN-fd1-fixTrue-f0-cosTrue-sinFalse-best-37.pt.tar"

# ================= Evaluating ===================== #
replay=False
write_wav = True
all_metrics = True
inference_dataset_name = 'val' # val train_pretrain test replay
ckpt_epoch = 93 # 54
...
ckpt = f"uTGT-LPS_IPD-b32-BN-fd1-fixTrue-f0-cosTrue-sinFalse-best-{ckpt_epoch}.pt.tar"
...
model_save_dir = sum_dir + f'/model_mvdr-AF_premasking={AF_premasking}-Batch_Size={batch_size}-Dloading={diag_loading_ratio}-add_visual={add_visual}/'
