...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument("--fbank-fmin", type=float, default=20.0, help="")
    ...
    parser.add_argument(
        ...
        type=strtobool,
        default=False,
        help="The flag to switch to use pca.",
    )
    parser.add_argument(
        "--vidim", default=80, type=int, help="video pca dim"
    )
    return parser
    ...
    if args.use_ddp:
        ...
        if args.num_spkrs == 1:
            if args.backend == "chainer":
                ...
                from espnet.online_feature_av_training.asr import train
                # import pdb; pdb.set_trace()
                train(args)
            else:
